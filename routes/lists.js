...
router.post('/:username/lists/addBook/1',isNotLoggedIn,allegedUser,catchAsync(lists.addBook1))
...
router.delete('/:username/lists/:id/books/:isbn',isNotLoggedIn,allegedUser,catchAsync(lists.removeBook))                         // Open a list  R
